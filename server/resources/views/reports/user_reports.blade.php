                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"
                                                  id="inputGroup-sizing-secondary">Start Date</span>
                                        </div>
                                        <input max="{{ $today }}" name="filter_user_start" id="filter_user_start"
                                               required type="date" class="form-control"
                                               aria-label="Sizing example input"
                                               aria-describedby="inputGroup-sizing-secondary">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input max="{{ $today }}" name="filter_user_end" id="filter_user_end" required
                                               type="date" class="form-control" aria-label="Sizing example input"
